...
public class datatypes{
    ...
    public static void longstuff(){
        ...
        String nln=("\n");
        String longdescription = ("The short is the sme  size of an int, its maximum value is 9,223,372,036,854,775,807 and its minimum value is -9,223,372,036,854,775,808");
        String examples=("Could Be used for:\n"
